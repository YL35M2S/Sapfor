...
public interface AptitudeDao {
     ...
     * 
     * @param id
     *            L'id de l'aptitude à rechercher dans la DAO
     * @return Un objet Aptitude correspondant à l'aptitude recherchée. Si
     *         l'aptitude n'est pas présente dans la DAO, l'objet Aptitude est
     *         initialisé à null
     * @throws DAOException
     *             si la mise à jour dans la DAO a provoqué une Exception
     */
     ...
     * 
     * @param aptitude
     *            l'aptitude à mettre à jour dans la DAO
     * @throws DAOException
     *             si la mise à jour dans la DAO a provoqué une Exception
     */
     ...
     * 
     * @param aptitude
     *            l'aptitude à rechercher dans la DAO
