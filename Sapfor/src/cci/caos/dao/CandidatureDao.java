...
public interface CandidatureDao {
     ...
     * @throws DAOException
     *             si la création dans la DAO a provoqué une Exception
     */
     ...
     * @throws DAOException
     *             si la recherche dans la DAO a provoqué une Exception
     */
     ...
     * session idSession existe dans la DAO
     * 
     * @param idAgent
     *            L'id d'un agent
     * @param idSession
     ...
     * @throws DAOException
     *             si la recherche des candidatures existantes dans la DAO a
     ...
     * @throws DAOException
     *             si la recherche des candidatures de cet agent dans la DAO a
     *             provoqué une Exception
     */
     ...
     *             session dans la DAO a provoqué une Exception
     */
     ...
     * @throws DAOException
     *             si la mise à jour des candidatures dans la DAO a provoqué une
     *             Exception
     */
     ...
     * @throws DAOException
     *             si la suppression de la candidature dans la DAO a provoqué
     *             une Exception
     */
    public void supprimerCandidature( Candidature candidature ) throws DAOException;

    /**
     * Supprime une candidature d'un agent donné pour une session donnée dans la
     * DAO
     * 
     * @param idAgent
     *            l'id de l'agent concerné
     ...
     * @throws DAOException
     *             si la recherche de la candidature dans la DAO a provoqué une
     *             Exception
     */
