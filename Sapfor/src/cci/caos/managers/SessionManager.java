...
public class SessionManager {
    ...
    public String fermerCandidature( @PathParam( "uuid" ) String id, @QueryParam( "Session" ) String idSession ) {
        int ids = Integer.parseInt( idSession );

        return "<html> " + "<title>" + "Hello Jersey" + "</title>" + "<body><h1>Session</h1>"
                + "Nom de la Session: " +
                SapforServer.getSession().getSessionById( ids ).presenteToi() +
                "</body>" + "</html> ";
    }
