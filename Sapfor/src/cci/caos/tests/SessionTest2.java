...
public class SessionTest2 {
    ...
    @Test
    // Resultat Attendu: Liste avec la session d'id 1, 2 et 3
    public void testListeSessionsOuvertes() throws IOException {
        ...
        liste_session_ouvertes_attendues.add(server.getSessionById(1));
